...
///通用下上刷新控件
class HZYPullLoadWidget extends StatefulWidget {
  ///item渲染
  ...
  @override
  _HZYPullLoadWidgetState createState() => _HZYPullLoadWidgetState();
}

class _HZYPullLoadWidgetState extends State<HZYPullLoadWidget> {
